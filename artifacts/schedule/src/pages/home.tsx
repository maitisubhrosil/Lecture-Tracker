        ...
        <div className="max-w-2xl mx-auto px-4 py-4 space-y-4">
          <div className="flex items-center justify-between gap-3">
            <div className="space-y-1">
              ...
              <div
                className="inline-flex items-center gap-1.5 rounded-full border border-indigo-100 bg-white/80 px-2.5 py-1 text-[11px] font-semibold text-indigo-600 shadow-sm"
                data-testid="stats-active-subscribers"
              >
      ...
      {!isLoading && (
        <footer className="max-w-2xl mx-auto px-4 pt-10 pb-4 text-center">
          <p className="text-[11px] text-gray-300">
            updates at 5:30 AM · 11:30 AM · 5:30 PM IST · IIM Raipur ePGP Batch 5
          </p>
        </footer>
      )}
    </div>
